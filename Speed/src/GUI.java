...
import otherStuff.Database_Config;
...
public class GUI {
    ...
    private static int maxSpeedCount;
    ...
    private JFormattedTextField currentSpeed;
...
//    private JRadioButton offButton;
    ...
    private int VCurrentSpeed = 0;
    private PreparedStatement ps00;
    ...
    public void initGUI() {
        frame = createJFrame("Smart Vehicle Speed Analyser");
...
//                            System.out.println("The video has finished!");
    ...
    public synchronized void speedMeasure(CountVehicles countVehicles) throws WriteException {
        if (!speed.isEmpty()) {
            ...
            if (countVehicles.isToSpeedMeasure()) {
                ...
                //set Max Speed
                if (currentSpeed >= 50) {
                    this.currentSpeed.setText(VCurrentSpeed++ + "");
                    ...
                    try {
                        ...
                        ps00 = new Database_Config().getConnection().prepareStatement("INSERT INTO vehicle (registrationNumber,date,driver_iddriver,speed) VALUES (?,?,?,?)");
                        ps00.setString(1, "BGF-6758");
                        ps00.setDate(2, date);
                        ps00.setInt(3, 1);
                        ps00.setDouble(4, currentSpeed);
                        ps00.executeUpdate();
    ...
    private void loadFile(JFrame frame) {
        ...
        loadButton = new JButton("Open a video");
    ...
    private void saveFile(JFrame frame) {
        ...
        saveButton = new JButton("Save to a file");
    ...
    private void infoCars(JFrame frame) {
        ...
        JLabel MaxSpeed = new JLabel("High Speed", JLabel.CENTER);
        MaxSpeed.setFont(new Font("defaut", Font.BOLD, 15));
        ...
        currentSpeed = new JFormattedTextField(numberFormat);
        currentSpeed.setForeground(Color.WHITE);
        currentSpeed.setValue(new Integer(0));
        currentSpeed.setBackground(Color.RED);
        currentSpeed.setEditable(false);
        currentSpeed.setPreferredSize(new Dimension(50, 30));
        currentSpeed.setHorizontalAlignment(JFormattedTextField.CENTER);
        ...
        c.gridy = 12;
        c.gridwidth = 1;
        c.insets = new Insets(0, 100, 5, 5);
        frame.add(currentSpeed, c);

        c.gridx = 6;
        c.gridy = 11;
        c.gridwidth = 1;
        c.insets = new Insets(0, 100, 5, 5);
        frame.add(MaxSpeed, c);
    }
    ...
    private void setupDistanceBetweenLines(JFrame frame) {
        JLabel distanceBLLabel = new JLabel("Distance between lines [m]: 6", JLabel.LEFT);
    ...
    private void selectCountingLine(JFrame frame) {
        ...
        countingLineButton = new JButton("Create a Count Line");
    ...
    private void selectSpeedLine(JFrame frame) {
        ...
        speedLineButton = new JButton("Create a Speed line");
    ...
    private void currentTime(JFrame frame) {
        ...
        currentTimeLabel.setFont(new Font("Arial", Font.BOLD, 15));
